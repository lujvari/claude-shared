...
CLOUDFLARE_ACCOUNT_ID="<account-id>"   # not a secret; omit for single-account tokens
```

```bash
claude-docker --cloudflare ~/repo
npx wrangler whoami        # in-container: authenticated as the token's identity
```
